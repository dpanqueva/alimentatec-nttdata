package com.alimentatec.usernotify.common.aspect.general;


import com.alimentatec.usernotify.common.model.enums.EConstantsVariables;
...
public class ApiLogsGeneralAspect {
     ...
     */
    @Pointcut("execution(* com.telefonica.campaigntrazability.controller.*.*(..))")
